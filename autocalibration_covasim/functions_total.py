...
from autocalibration_covasim.func import *
from autocalibration_covasim.SARIMAX import *
...
def calibration_process(popdict, param, location, pop_location, datafile, start_day, end_day, pop_inf, cal_keys, cal_values,
...
def run_model(p, popdict, location, pop_location, start_day, end_day, b_days, b_changes, data, run, school_days=None, school_changes=None, to_plot=['new_diagnoses','new_deaths', 'new_infections']):
